...
function ENT:Draw()
    ...
    cam.Start3D2D(pos, ang, 0.12)
        ...
        draw.SimpleText("DETPACK", "KTNE_Title", 0, -46, THEME.title, TEXT_ALIGN_CENTER)
        local line1 = self:GetGameActive() and ("Time: " .. self:GetTimeRemaining() .. "s") or "Use to start Detpack"
