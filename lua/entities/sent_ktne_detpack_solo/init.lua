    ...
    self.ManualData = {
        ...
        overview = {
            ...
            lines = {
                ...
                "No datapad access terminal is present on this Detpack configuration.",
...
function ENT:Use(activator)
    ...
    if not role then
        activator:ChatPrint("This Detpack bomb is already in use by another player.")
        return
    end
...
function ENT:StartGame()
    ...
    self:NotifyPlayers("Detpack single-player bomb started. Defuse all four modules before the " .. formatChatTimeRemaining(startTime) .. " timer expires.")
