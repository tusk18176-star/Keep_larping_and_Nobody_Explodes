...
local function updateTensionTrack(ent, state)
    if not IsValid(ent) or not KTNE_ClientAudio then return end
...
local function ensureDatapadLayout(frame)
    ...
    canvas.Paint = function(_, w, h)
        ...
        local activeModule = seismic.active == true or pkb.active == true or seal.active == true
        ...
        elseif seal.active == true then
            ...
            draw.SimpleText("ABBERANT DATAPAD MODULE / HEAT VENTING", "KTNE_SubTitle", centerX, boxY + 30, titleCol, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function ENT:Draw()
    ...
    cam.Start3D2D(pos, ang, 0.12)
        ...
        draw.SimpleText("ABBERANT BOMB", "KTNE_Title", 0, -46, THEME.title, TEXT_ALIGN_CENTER)
        ...
        draw.SimpleText("Holo-panel styling active. Six live modules installed.", "KTNE_Small", 0, 44, THEME.text, TEXT_ALIGN_CENTER)
    cam.End3D2D()
end
