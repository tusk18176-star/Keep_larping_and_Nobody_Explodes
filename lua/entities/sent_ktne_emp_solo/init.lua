...
function ENT:Initialize()
    self:SetModel("models/releasepackprops/capicator.mdl")
...
function ENT:GenerateModules()
    ...
    self.ModuleSlots[5] = "electric"
    self.Modules.electric = generated.electric
    ...
    self.ManualData = {
        ...
        overview = {
            ...
            lines = {
                ...
                "Slots 1 through 4 are randomized when the round starts.",
                "Slot 5 contains the Electric Flow Control module.",
                "No datapad access terminal is present on this EMP configuration.",
                "Solve all five active modules before the timer reaches zero.",
...
function ENT:StartGame()
    ...
    self:NotifyPlayers("EMP single-player bomb started. Defuse all five modules before the " .. formatChatTimeRemaining(startTime) .. " timer expires.")
