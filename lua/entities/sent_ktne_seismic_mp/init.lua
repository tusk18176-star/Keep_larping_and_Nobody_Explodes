...
function ENT:GenerateModules()
    ...
    self.Seismic = buildSeismicState()
    self.PKB = {active = false, phase = "idle", timer = 0, colors = {}, connections = {}, blocked = {}, completed = {}, completedPaths = {}, draggingColor = nil, dragVisited = {}, lastDragKey = nil}
    ...
    self.ModuleSlots[5] = "interrupt"
    self.Modules.interrupt = generated.interrupt
    self.ModuleSlots[6] = "calibration"
    self.Modules.calibration = generated.calibration
    ...
    self.ManualData = {
        ...
        overview = {
            ...
            lines = {
                ...
                "Slot 5 contains Interrupt Vibration Pattern. Slot 6 contains Seismic Calibration.",
                "The datapad terminal runs the Seismic module.",
...
function ENT:StartGame()
    ...
    self:NotifyPlayers("Seismic bomb started. Defuse all six visible modules within " .. formatChatTimeRemaining(startTime) .. ".")
