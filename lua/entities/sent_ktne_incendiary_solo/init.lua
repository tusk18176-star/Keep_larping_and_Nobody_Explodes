...
function ENT:GenerateModules()
    ...
    self.ModuleSlots[5] = "thermo"
    self.Modules.thermo = generated.thermo
    ...
    self.ManualData = {
        ...
        overview = {
            ...
            lines = {
                ...
                "Slot 5 contains the Thermo Regulation module.",
                "No datapad access terminal is present on this Incendiary configuration.",
...
function ENT:Use(activator)
    ...
    if not role then
        activator:ChatPrint("This Incendiary bomb is already in use by another player.")
        return
    end
